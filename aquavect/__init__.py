...
Modules:
    agents       - Agent types and data model
    networks     - Topology generators and centrality utilities
    simulation   - Core simulation engine
    aggregation  - Information aggregation mechanisms
    metrics      - Statistical metrics and scoring
    datagen      - Synthetic data generation pipeline
    formatting   - Trace-to-text conversion for LLM training
    benchmark    - Evaluation benchmark for network reasoning
    viz          - Visualization in Aquavect visual style
